...
# 47. IMPORTANT FINAL INSTRUCTION TO CLAUDE
...
# 49. CLAUDE CODE AGENT — BLOCK-BY-BLOCK EXECUTION PLAN

Mulai bagian ini, kamu tidak hanya menjadi advisor. Kamu bertindak sebagai **Claude Code Agent yang bekerja langsung di repository project saya**.
...
Memastikan Claude Code memahami kondisi repository **tanpa mengubah apa pun**.

## Prompt yang diberikan ke Claude Code
...
Saya akan memberikan block satu per satu kepada Claude Code.

Setelah setiap block:

1. Claude Code harus melakukan pekerjaan block tersebut.
2. Claude Code harus menjalankan acceptance checks.
3. Claude Code harus menampilkan perubahan utama.
4. Claude Code harus menampilkan `git status`.
5. Claude Code harus melakukan commit semantic.
6. Claude Code harus berhenti.
7. Saya baru akan memberikan block berikutnya.

Claude Code **DILARANG melompat ke block berikutnya tanpa instruksi saya**.

---

# 78. FORMAT RESPONS CLAUDE CODE SETIAP SELESAI BLOCK
...
Claude Code harus **STOP** dan melapor jika menemukan:
...
Saya ingin Claude Code bertindak seperti:
...
# END OF CLAUDE CODE EXECUTION PLAN
